...
@props(['margin','color'=>'pink'])



<form class="flex flex-wrap gap-3 w-full p-5 {{$margin}}">
    <label class="relative w-full flex flex-col">
      <span class="font-bold mb-3" >{{$title}}</span>
      <input class="rounded-md peer pl-12 pr-2 py-2 border-2 border-{{$color}}-200 placeholder-{{$color}}-300" type="text" name="card_number" placeholder="0000 0000 0000" />
    ...
    <label class="relative flex-1 flex flex-col">
      <span class="font-bold mb-3">{{$contentform}}</span>
      <input class="rounded-md peer pl-12 pr-2 py-2 border-2 border-{{$color}}-200 placeholder-{{$color}}-300" type="text" name="expire_date" placeholder="MM/YY" />
      <svg xmlns="http://www.w3.org/2000/svg" class="absolute bottom-0 left-0 -mb-0.5 transform translate-x-1/2 -translate-y-1/2 text-black peer-placeholder-shown:text-gray-300 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <label class="relative flex-1 flex flex-col">
      ...
      <input class="rounded-md peer pl-12 pr-2 py-2 border-2 border-{{$color}}-200 placeholder-{{$color}}-300" type="text" name="card_cvc" placeholder="&bull;&bull;&bull;" />
      <svg xmlns="http://www.w3.org/2000/svg" class="absolute bottom-0 left-0 -mb-0.5 transform translate-x-1/2 -translate-y-1/2 text-black peer-placeholder-shown:text-gray-300 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
