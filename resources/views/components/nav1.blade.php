...
<div class=" place-items-center h-auto space-between">
        ...
        <!-- navbar -->
    <nav class="flex justify-between bg-blue-900 text-white mb-5">
        <div class="px-5 xl:px-12 py-6 flex w-full items-center">
          ...
          <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
            ...
            <li><a class="hover:text-gray-200" href="{{route("profile")}}">Profile</a></li>
          ...
          <div class="hidden xl:flex items-center space-x-5 items-center">
            ...
            <!-- Sign In / Register      -->
                ...
                @if (Route::has('login'))
                      ...
                      @else
                      <div><a href="{{ route('login') }}" class="hover:text-gray-200">Log in</a></div>
                          @if (Route::has('register'))
                          <div><a href="{{ route('register') }}" class="hover:text-gray-200">Register</a></div>
                          @endif
                      @endauth
                @endif
