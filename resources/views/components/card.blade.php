...
<div class="absolute bottom-0 right-0 mb-4 mr-4 z-10">
    <div>
        <a class="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12 border-solid border-4 border-{{$color}}-500">
